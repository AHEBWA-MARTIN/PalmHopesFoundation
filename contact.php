...
<head>
    ...
    <!-- Title -->
    <title>Palm Hopes Foundation| Contact</title>
                    ...
                    <div class="col-12">
                        <div class="top-header-content d-flex flex-wrap align-items-center justify-content-between">
                            ...
                            <div class="top-header-meta">
                                <a href="mailto:info.deercreative@gmail.com" class="email-address"><i class="fa fa-envelope" aria-hidden="true"></i> <span>info.palmhopesfoundation@gmail@gmail.com</span></a>
                        ...
                        <div class="row">
                            <div class="col-12 col-md-4">
                                <div class="contact-content contact-information">
                                    <h4>Contact</h4>
                                    <p>info.palmhopesfoundation@gmail.com</p>
                                    <p>(+256) 789 - 610 - 816</p>
                                </div>
                            </div>
                            <div class="col-12 col-md-4">
                                <div class="contact-content contact-information">
                                    <h4>Address</h4>
                                    <p>Kabwohe town, Sheema District</p>
                                    <p>Western Uganda, Uganda</p>
                                </div>
                            </div>
                            <div class="col-12 col-md-4">
                                <div class="contact-content contact-information">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <input type="email" class="form-control" id="contact-email" placeholder="info.palmhopes@gmail.com" required>
                                    </div>
                                </div>
                                <div class="col-12 col-lg-4">
                                    <div class="form-group">
                                        <label for="contact-number">Phone*:</label>
                                        <input type="text" class="form-control" id="contact-number" placeholder="(+256) 789 610 816" required>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-group">
                    ...
                    <div class="col-12 col-sm-6 col-lg-3">
                        <div class="single-footer-widget mb-70">
                            ...
                            <div class="single-latest-news">
                                ...
                                <p><i class="fa fa-calendar" aria-hidden="true"></i> Sept 17, 2024</p>
                            </div>
