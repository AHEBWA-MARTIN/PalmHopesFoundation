...
<head>
    ...
    <!-- Title -->
    <title>Palm Hopes Foundation| Gallery</title>
...
<body>
    ...
    <div class="gallery-area d-flex flex-wrap">
        ...
        <div class="single-gallery-area">
            <a href="img/palm/program.jpg" class="gallery-img" title="Gallery Image 1">
                <img src="img/palm/program.jpg" alt="">
            </a>
        </div>

        <!-- Single Gallery Area -->
        <div class="single-gallery-area">
            <a href="img/palm/academy.jpg" class="gallery-img" title="Gallery Image 2">
                <img src="img/palm/academy.jpg" alt="">
            </a>
        </div>

       <!-- Single Gallery Area -->
        <div class="single-gallery-area">
            <a href="img/palm/neck.jpg" class="gallery-img" title="Gallery Image 1">
                <img src="img/palm/neck.jpg" alt="">
            </a>
        </div>

        <!-- Single Gallery Area -->
        <div class="single-gallery-area">
            <a href="img/palm/members.jpg" class="gallery-img" title="Gallery Image 2">
                <img src="img/palm/members.jpg" alt="">
            </a>
        </div>

        <!-- Single Gallery Area -->
        <div class="single-gallery-area">
            <a href="img/palm/preaching.jpg" class="gallery-img" title="Gallery Image 1">
        ...
        <!-- Single Gallery Area -->
        <div class="single-gallery-area">
            <a href="img/palm/hist.jpg" class="gallery-img" title="Gallery Image 2">
                <img src="img/palm/hist.jpg" alt="">
            </a>
        </div>

       <!-- Single Gallery Area -->
        <div class="single-gallery-area">
            <a href="img/palm/re.jpg" class="gallery-img" title="Gallery Image 1">
                <img src="img/palm/re.jpg" alt="">
            </a>
        </div>

        <!-- Single Gallery Area -->
        <div class="single-gallery-area">
            <a href="img/palm/ball.jpg" class="gallery-img" title="Gallery Image 2">
                <img src="img/palm/ball.jpg" alt="">
            </a>
        </div>

       <!-- Single Gallery Area -->
        <div class="single-gallery-area">
            <a href="img/palm/graduation.jpg" class="gallery-img" title="Gallery Image 1">
                <img src="img/palm/graduation.jpg" alt="">
            </a>
        </div>

        <!-- Single Gallery Area -->
        <div class="single-gallery-area">
            <a href="img/palm/staff.jpg" class="gallery-img" title="Gallery Image 2">
		 ...
		 <!-- Single Gallery Area -->
        <div class="single-gallery-area">
            <a href="img/palm/necklaces.jpg" class="gallery-img" title="Gallery Image 1">
                <img src="img/palm/necklaces.jpg" alt="">
            </a>
        </div>

        <!-- Single Gallery Area -->
        <div class="single-gallery-area">
            <a href="img/palm/sports.jpg" class="gallery-img" title="Gallery Image 2">
                <img src="img/palm/sports.jpg" alt="">
            </a>
        </div>

       <!-- Single Gallery Area -->
        <div class="single-gallery-area">
            <a href="img/palm/skill.jpg" class="gallery-img" title="Gallery Image 1">
        ...
        <!-- Single Gallery Area -->
        <div class="single-gallery-area">
            <a href="img/palm/liqiu.jpg" class="gallery-img" title="Gallery Image 2">
                <img src="img/palm/liqiu.jpg" alt="">
            </a>
        </div>

        <!-- Single Gallery Area -->
        <div class="single-gallery-area">
            <a href="img/palm/farmer.png" class="gallery-img" title="Gallery Image 1">
                <img src="img/palm/farmer.png" alt="">
            </a>
        </div>
		
		 <!-- Single Gallery Area -->
        <div class="single-gallery-area">
            <a href="img/palm/cake.jpg" class="gallery-img" title="Gallery Image 1">
                <img src="img/palm/cake.jpg" alt="">
            </a>
        </div>

        <!-- Single Gallery Area -->
        <div class="single-gallery-area">
            <a href="img/palm/staf.jpg" class="gallery-img" title="Gallery Image 2">
                <img src="img/palm/staf.jpg" alt="">
            </a>
        </div>

       <!-- Single Gallery Area -->
        <div class="single-gallery-area">
            <a href="img/palm/play.jpg" class="gallery-img" title="Gallery Image 1">
                <img src="img/palm/play.jpg" alt="">
            </a>
        </div>

        <!-- Single Gallery Area -->
        <div class="single-gallery-area">
            <a href="img/palm/easter.jpg" class="gallery-img" title="Gallery Image 2">
                <img src="img/palm/easter.jpg" alt="">
            </a>
        </div>

        <!-- Single Gallery Area -->
        <div class="single-gallery-area">
            <a href="img/palm/direc.jpg" class="gallery-img" title="Gallery Image 1">
                <img src="img/palm/direc.jpg" alt="">
            </a>
        </div>
