...
<head>
    ...
    <!-- Title -->
    <title>Palm Hopes Foundation| Careers</title>
                ...
                <div class="col-12">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Fun Times</li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="row align-items-center justify-content-between">
                <div class="col-12 col-lg-5">
                    <div class="about-content">
                        <h2>Fun and Dance At Palm Hopes Foundation</h2>
                         <p style ="font-size: 16.5px; color: black; text-align:justify;">Uganda is home to rich diversity of African cultures and subcultures. One way you can feel and experience this part of Uganda’s endowments is by traditional cultural dances with our children in the Foundation. Your stay at the Foundation with us always ends with a thrilling and exhilarating cultural dance performed by our kids. Our dances are based on the tribes we have in sheema district and those that neighbor us. One of the dances we perform is Kinyankole cultural dance, a dance valued and performed by the Banyankole, the dominant inhabitants of the area.

</p>
                        <p style ="font-size: 16.5px; color: black; text-align:justify;">Kinyankole dance is a local cultural dance commonly danced in our community because it symbolizes and is a significant heritage to the Banyankole tribe, a dominant tribe in the whole district.  This interesting dance is danced by shaking the whole bums and twisting the bodies which helps Children and all participants get physical therapy and exercises. The dance also teaches people how they should live, and work hard in the communities for sustainable development of their economies.

</p>
						<p style ="font-size: 16.5px; color: black; text-align:justify;">Apart from Kinyankole dance, we also perform other cultural dances including among others Kiga dance, Kinyarungulu dance and Kiganda dance. This is a full buffet menu of cultural dances in Uganda, majorly western and central Uganda cultures that will give you the best of Uganda. All these dances are always danced in ceremonies like traditional marriages and whenever people are in happy moods of socializing with others while sipping their locally brewed beer.
</p>
                ...
                <div class="col-12 col-lg-6">
                    <div class="about-thumbnail">
                        <img src="img/palm/411.jpg" alt="">
						<img src="img/palm/fundrise.jpg" alt="">
                    </div>
                </div>
            </div>
        </div>
