...
<head>
    ...
    <!-- Title -->
    <title>Palm Hopes Foundation| Education</title>
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="sermons-text text-center">
                        <h2>Promoting Access to a Better Education</h2>
						<br></br>
                ...
                <div class="col-12 col-sm-6 col-lg-4">
                    <div class="single-why-choose-us mb-100">
                        ...
                        <h4>Our Vision</h4>
                        <p style ="font-size: 16.5px; color: black; text-align:justify;">To produce upright citizens with skills, knowledge and self esteem to suit millenium challenges.</p>
                    </div>
                </div>
                <!-- Single Why Choose Area -->
                <div class="col-12 col-sm-6 col-lg-4">
                    <div class="single-why-choose-us mb-100">
                        ...
                        <h4>Our Mission</h4>
                        <p style ="font-size: 16.5px; color: black; text-align:justify;">We are dedicated to provide world class educational stadards through a local setting that serves a local setting that serves a non-discriminative fully fledged program for greater heights.</p>
                    </div>
                </div>
                <!-- Single Why Choose Area -->
                <div class="col-12 col-sm-6 col-lg-4">
                    <div class="single-why-choose-us mb-100">
                        ...
                        <h4>What We Do?</h4>
                        <p style ="font-size: 16.5px; color: black; text-align:justify;">Children Education and Women Skills Training.</p>
                    </div>
                </div>
				 <h2>JOIN US TODAY</h2>
            </div>
                    ...
                    <div class="col-12 col-sm-6 col-lg-3">
                        <div class="single-footer-widget mb-70">
                            ...
                            <div class="single-latest-news">
                                ...
                                <p><i class="fa fa-calendar" aria-hidden="true"></i> August 11, 2024</p>
                            </div>
