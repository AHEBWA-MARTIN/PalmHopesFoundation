...
<body>
    <header>
        <nav>
             <a href="index.php" class="nav-brand"><img src="img/log.jpg" alt=""></a>

            
                <ul>
                 <h2 style ="color:#1f1f2c; text-align:center;">VOLUNTEER REGISTRATION FORM</h2>                  
            </ul>
        </nav>
    </header>
